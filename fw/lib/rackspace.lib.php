...
class RscApi {
     ...
     */
    public function serverAddressShare($serverId, $ipAddress, $sharedIpGroupId, $configure = FALSE) {
        $data = array(
            "shareIp" => array(
     ...
     */
    public function serverCreate($name, $imageId, $flavorId, $sharedIpGroupId = NULL) {
        $data = array(
            "server" => array(
                "name" => $name,
                "imageId" => $imageId,
